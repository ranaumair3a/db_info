...
<body class="bg-gray-100 font-sans">
    <?php
    include_once('config_seci.php'); // Ensure this contains your DB connection
    ...
    if (isset($_POST['rno'])) {
        ...
        $updatedMarks = [
            ...
            'ps' => $_POST['ps'] ?? 0,
            'maths' => $_POST['maths'] ?? 0,
            'marks6' => $_POST['marks6'] ?? 0,
            'marks7' => $_POST['marks7'] ?? 0,
            'marks8' => $_POST['marks8'] ?? 0
        ];
        ...
        if (mysqli_stmt_prepare($stmt, $updateQuery)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $successMessage = "Error updating result: " . mysqli_error($con);
            }
        } else {
            $successMessage = "Error preparing statement: " . mysqli_error($con);
        }
    ...
    <script>
        ...
        function updateResult() {
            ...
            rollNoInput.name = 'update_roll_no';
            rollNoInput.value = '<?php echo $rno; ?>';
            form.appendChild(rollNoInput);

            document.querySelectorAll('.marks-input').forEach(input => {
                const subjectInput = document.createElement('input');
                subjectInput.type = 'hidden';
                subjectInput.name = input.name;
    ...
    <div class="container mx-auto p-4 max-w-4xl">
        ...
        <?php if ($rno && $data): ?>
            <?php if ($successMessage): ?>
                <div class="text-center text-green-600 font-bold mb-4"><?php echo $successMessage; ?></div>
            <?php endif; ?>
